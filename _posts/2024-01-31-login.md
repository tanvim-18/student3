      ...
      fetch("http://127.0.0.1:8086/api/users/authenticate", requestOptions)
          .then(response => {
            if (response.ok) {
                ...
                window.location.href = "http://localhost:4200/student/2024/01/31/wordle.html"
              } else {
  ...
  <form action="javascript:login_user()">
    ...
    <p>
     <button class="button-spacing">Log In</button>
          <button onClick = "window.location.href ='http://localhost:4200/student/2024/01/31/signup.html'" class="button-spacing" >Sign Up</button>
